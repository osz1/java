...
public class WordListing {
    ...
    public static String checkFileForRead(Path p) {
        if (Files.exists(p)) {
    ...
    public static String checkFileForOverwrite(Path p) {
        if (Files.isRegularFile(p)) {
            if (Files.isReadable(p)) {
                return "";
            } else {
    ...
    public static void run(Scanner scan) {
        ...
        while (run1) {
            ...
            if (input.isEmpty()) {
                ...
                String fileCheckingForRead = checkFileForRead(p);
                    ...
                    while (run2) {
                        ...
                        if (input.isEmpty()) {
                            ...
                            if (!fileExisting.isEmpty()) {
                                ...
                                String fileCheckingForOverwrite = checkFileForOverwrite(p);
